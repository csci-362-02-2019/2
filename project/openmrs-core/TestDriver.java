...
public class TestDriver extends LuhnIdentifierValidator {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//Test 2
			boolean result2;
			String line2 = Files.readAllLines(Paths.get("/home/wright/testCases/testcase2.txt")).get(4);
			...
			try {
				...
				boolean result3;
				String line3 = Files.readAllLines(Paths.get("//home/wright/testCases/testcase3.txt")).get(4);
			...
			int result4;
			String line4 = Files.readAllLines(Paths.get("/home/wright/testCases/testcase4.txt")).get(4);
			...
			int result5;
			String line5 = Files.readAllLines(Paths.get("/home/wright/testCases/testcase5.txt")).get(4);
