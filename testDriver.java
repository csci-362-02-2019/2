...
class testdriver2 {
	...
	public static void main(String[] args) {
		try {
			...
			//test case 24
			boolean isYester24;
			String line24 = Files.readAllLines(Paths.get("../2/TestAutomation/testCases/testcase023")).get(4);	
			String sub1 = line24.substring(0, line24.indexOf(","));
			String sub2 = line24.substring(line24.indexOf(",")+1, line24.lastIndexOf(","));
			String sub3 = line24.substring(line24.lastIndexOf(","), line24.length());
			Date date24 = new Date(Integer.parseInt(sub1), Integer.parseInt(sub2), Integer.parseInt(sub3));
			isYester24 = isYesterday(date24);

			//test case 25
			boolean isYester25;
			String line25 = Files.readAllLines(Paths.get("../2/TestAutomation/testCases/testcase023")).get(4);
			String subA = line25.substring(0, line25.indexOf(","));
			String subB = line25.substring(line25.indexOf(","), line25.lastIndexOf(","));
			String subC = line25.substring(line25.lastIndexOf(","), line25.length());		
			Date date25 = new Date(Integer.parseInt(subA), Integer.parseInt(subB), Integer.parseInt(subC));
			isYester25 = isYesterday(date25);
			...
			String result24 = Boolean.toString(isYester24);
			String result25 = Boolean.toString(isYester25);
